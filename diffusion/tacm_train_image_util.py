...
class TrainLoop():
    def __init__(
        ...
        *,
        ...
        self.processor = CLIPProcessor.from_pretrained("tacm/modules/cache/clip-vit-large-patch14")
    ...
    def run_loop(self):
        while (
            ...
            for i, sample in enumerate(self.data):
                ...
                c = sample['text'].squeeze(1).to(dist_util.dev())
                ...
                for j in range(image.shape[0]):
                    ...
                    if image_cat is None:
                        ...
                        image_cat = th.concat((image_cat, image_features.unsqueeze(0)), dim=0) #torch.Size([bs, 1, 768])

...
class GaussianDiffusion:
    ...
    def p_mean_variance(self, model, x, t, c, clip_denoised=True, denoised_fn=None, model_kwargs=None):
        """
    ...
    def p_sample(
        self, model, x, t, c, clip_denoised=True, denoised_fn=None, cond_fn=None, model_kwargs=None,
    ):
        """
    ...
    def p_sample_loop_progressive(
        ...
        if init_image is not None:
            if len(shape) == 4:
                ...
                batch_size = shape[0]
                init_image_batch = th.tile(init_image, dims=(batch_size, 1, 1, 1, 1))
    ...
    def _vb_terms_bpd(self, model, x_start, x_t, t, c, clip_denoised=True, model_kwargs=None):
        """

...
from .attention_ti import SpatialTransformer
from .attention_dual import DualSpatialTransformer, DualTemporalTransformer
from .attention_spatiotemp import AlphaBlender
...
class TemporalConvBlock_v1(nn.Module):
    ...
    def __init__(self,
        ...
        super(TemporalConvBlock_v1, self).__init__()
        if out_dim is None:
...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        legacy=True,
        use_dual_spatial_transformer=False,    # custom transformer support
        use_dual_temporal_transformer=False,
    ):
        super().__init__()
                ...
                if ds in attention_resolutions:
                    ...
                    layers.append(
                        AttentionBlock(
                            ...
                            num_head_channels=dim_head,
                            use_new_attention_order=use_new_attention_order,
                        ) if not use_temporal_transformer else DualTemporalTransformer(
                            ch, num_heads, dim_head, transformer_depth, cross_attention_dim=context_dim_2, disable_self_attn=False),
                    )
                ...
                if ds in attention_resolutions:
                    ...
                    layers.append(
                        AttentionBlock(
                            ...
                            ch, num_heads, dim_head, transformer_depth, cross_attention_dim=context_dim_2,
                            disable_self_attn=False)
                    )
    ...
    def forward(self, x, timesteps, context=None, context_temp=None, y=None, **kwargs):
        ...
        #emb = self.time_embed(sinusoidal_embedding(timesteps, self.model_channels))

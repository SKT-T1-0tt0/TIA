    ...
    def __init__(self, args) -> None:
        ...
        self.model.load_state_dict(
            torch.load(
                ...
                else "saved_ckpts/URMP_uncond_diffusion_0704/model300000.pt",
                map_location="cpu",
            )
        )
            ...
            for j, sample in enumerate(samples):
                ...
                if should_save_image or self.args.save_video:
                    ...
                    for b in range(self.args.batch_size):
                        ...
                        init_image_pil = self.init_image_pil.add(1).div(2).clamp(0, 1)
                        init_image_pil = TF.to_pil_image(init_image_pil)
